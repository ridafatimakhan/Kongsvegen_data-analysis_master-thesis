...
input_file_path = 'H:/Rida/13072021/M16/Other/M160101000000.txt'

# Define the desired output directory
output_directory = 'H:/Rida/filtered/13072021/M16/M160101000000.txt'
...
filtered_data['time_seconds'] = (filtered_data['time'] - t_1) * 0.001
filtered_data['time_minutes'] = filtered_data['time_seconds'] / 60

# Plot Pressure1 and Pressure2 over time
plt.figure(figsize=(12, 6))
plt.plot(filtered_data['time_minutes'], filtered_data['pressure1'], label='Filtered Pressure 1', color='blue')
plt.plot(filtered_data['time_minutes'], filtered_data['pressure2'], label='Filtered Pressure 2', color='green')
...
# Save the plot
plot_output_file = os.path.join(output_directory, 'filtered_pressure_plot.png')
os.makedirs(output_directory, exist_ok=True)
